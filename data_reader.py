...
class YesNoDataProcessor(DataProcessor):
    """Processor for YesNo data set"""
...
def convert_single_example(ex_index, example, label_list, max_seq_length,
    ...
    if example.label not in label_map:
        refined_label = example.label.strip('\"')
    else:
        refined_label = example.label

    label_id = label_map[refined_label]
    if ex_index < 5:
